package com.teka.aicalculatorappwithkoog.screens
...
data class CalcAgentUiState(
    val title: String = "Calc Agent",
    val messages: List<Message> = listOf(Message.SystemMessage("Hi, I'm your agentic calculator")),
...
class CalcAgentViewModel(
    ...
    val uiState: StateFlow<CalcAgentUiState> = _uiState.asStateFlow()
